...
for (i, rect) in enumerate(rects):
    ...
    for (x, y) in shape[60:65]:
        cv2.circle(image, (x, y), 1, (0, 0, 255), -1)

    # Separate upper and lower lips and show on image
    #cv2.polylines(image,[shape[48:55]],False,(0,255,255))
    upper_lip = np.concatenate((shape[48:55],np.flipud(shape[60:65])))
    cv2.polylines(image,[upper_lip],True,(0,255,255))
